...
export default function QuestionCard({
  ...
  return (
    <div className="relative h-full min-h-0 w-full flex flex-col">
      ...
      />
      {/* Scrollable bottom content. Flex-based height avoids `vh`/browser-UI clipping. */}
      <div className="relative z-10 flex-1 min-h-0 overflow-y-auto p-3 sm:p-4 md:p-5 pb-safe">
        <div className="min-h-full flex flex-col justify-end space-y-3 sm:space-y-4 w-full">
          {/* Question text */}
          <motion.h2
            style={{
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        touch-manipulation
                        group
                        ${isActive ? 'ring-2 ring-white/70 shadow-2xl' : 'shadow-lg'}
                      `}
                      aria-label={a.text}
                    >
